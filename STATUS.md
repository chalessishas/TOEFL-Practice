...
- [100%] mechanics.js 误报修复 — 字典未加载时跳过拼写检查（原行为：15k fallback 将 "commute/eliminates/mentorship" 等正确词误标为拼写错误）(54bab35) — 7/7 真错误命中，0 误报（排除 university/European/unique 等 /j/ 音词）(78fa6b1)
