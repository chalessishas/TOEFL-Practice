...
- [100%] Loop 30 (74ef691) — grammar.js ① SUCH_A_RE（两步法修复 bug：单步 such+名词 + 形容词中间步骤；"such problem" → "such a problem"；Peng 2012 CLEC；~12-15%；FP~2-3%）② ABSENT_IN_RE："absent in" → "absent from"（Longman/BNC；~3-5%；FP~1%）③ FAMILIAR_TO_AGENT_RE："I am familiar to" → "familiar with"（Xia 2016 JLTR；仅代词/角色名词主语；~5-8%；FP~1-2%）；10/10 单元测试，校准 S3=3.57<S4=3.74<S5=4.01 ✓
- [100%] Loop 29 (25e1aa9) — grammar.js ① NO_MATTER_PRON_RE："no matter we/he/she" → "no matter what/how"（中文无论+代词迁移；ERIC EJ1075251；BEA-2019；FP~0%）② SUBORD_BARE_3SG_RE："although he improve" → 从句第三人称单数需-s（Tandfonline 2020；~7-9%；FP~3-5%；15词封闭列表）③ BY_BARE_RE："by study/work/do" → "by studying/working"（通过+裸动词迁移；Celce-Murcia §14.6；40词白名单；~7-9%；FP~0%）；校准 ordering PASS ✓
