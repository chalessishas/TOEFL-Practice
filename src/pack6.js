...
Not all fungi are beneficial. Some pathogenic fungi cause diseases in plants and animals, leading to significant agricultural and ecological impacts. For example, the chytrid fungus has devastated amphibian populations worldwide. Understanding the diverse roles of fungi in ecosystems can help scientists develop strategies to mitigate their negative effects while leveraging their benefits for environmental sustainability.`,
          questions: [
            ...
            },
            {
              id: 24,
              paragraph: 1,
              text: 'The word "symbiotic" in paragraph 2 is closest in meaning to',
              options: [
                'mutually beneficial to both parties involved',
                'dependent on decomposition processes',
                'harmful to the host organism',
                'occurring only in underground soil environments',
              ],
              correct: 0,
              question_type: 'vocab',
              highlighted_word: 'symbiotic',
              explanation: '"Symbiotic" describes a relationship in which both organisms benefit. Mycorrhizal fungi extend plant root systems (plants gain nutrients) while receiving carbohydrates in return — both parties gain. "Mutually beneficial to both parties involved" captures this precisely. The relationship is not harmful (that would be parasitic), not defined by decomposition, and not limited to underground settings.',
            },
            {
              id: 25,
              paragraph: 2,
              text: 'Why does the author mention the chytrid fungus in paragraph 3?',
              options: [
                'To identify the most widespread type of fungus in global ecosystems',
                'To provide a specific example of how pathogenic fungi can cause ecological harm',
                'To argue that pathogenic fungi are more ecologically significant than beneficial ones',
                'To explain how scientists developed effective treatments for fungal diseases',
              ],
              correct: 1,
              question_type: 'purpose',
              highlighted_word: 'chytrid fungus',
              explanation: 'The author cites the chytrid fungus as a concrete example supporting the claim that some fungi cause "significant agricultural and ecological impacts." It illustrates the destructive capacity of pathogenic fungi by noting it has "devastated amphibian populations worldwide." The passage does not claim it is the most widespread, does not rank pathogens above beneficial fungi, and mentions no treatments.',
            },
            {
              id: 23,
              paragraph: null,
              ...
              lead_sentence: 'Fungi perform a variety of ecological roles — both beneficial and harmful — that are essential to the functioning of healthy ecosystems.',
              options: [
                'By decomposing dead organic material, fungi return vital nutrients such as nitrogen and phosphorus to the soil, making them available for plant growth.',
                'Mycorrhizal fungi form mutualistic relationships with plant roots, extending their reach and improving access to water and nutrients in exchange for carbohydrates.',
                'Certain pathogenic fungi cause diseases in plants and animals, with the chytrid fungus serving as a notable example of their ecological destructiveness.',
                'Unlike plants, fungi generate their own energy through photosynthesis, allowing them to thrive even in nutrient-poor environments with little organic matter.',
                'Mycorrhizal fungi primarily harm their host plants by drawing away carbohydrates that the plants would otherwise use for their own growth.',
                'Scientists have developed effective chemical treatments to eliminate pathogenic fungi, significantly reducing their impact on amphibian populations worldwide.',
              ],
              correct: [0, 1, 2],
              explanation: 'The passage develops three main ideas: (A) fungi decompose matter and recycle nutrients (P1), (B) mycorrhizal fungi form symbiotic partnerships with plant roots (P2), and (C) some fungi are pathogenic and cause significant ecological harm (P3). Option D contradicts the passage, which explicitly states fungi do NOT photosynthesize. Option E reverses the mutualistic relationship — mycorrhizal fungi benefit plants, not harm them. Option F is fabricated; the passage says chytrid has "devastated" amphibians and implies no effective remedy.',
            },
          ],
        },
      ],
...
Recent innovations are addressing these issues. For instance, researchers are developing more efficient solar panels and energy storage systems that can store excess power generated during peak times. Wind turbines are being designed to operate in lower wind speeds, increasing their efficiency. Governments and private companies are also investing in renewable energy projects, recognizing the importance of transitioning to sustainable energy sources.`,
          questions: [
            ...
            },
            {
              ...
              options: [
                'not continuous or consistent in output',
                'environmentally harmful under certain conditions',
                'too expensive to produce at large scale',
                'dependent on continuous human operation',
              ],
              correct: 0,
              question_type: 'vocab',
              highlighted_word: 'intermittent',
              explanation: '"Intermittent" means occurring at irregular intervals — not continuous. The passage uses it to describe how solar and wind energy output varies with weather conditions: they "can be inconsistent depending on weather conditions." "Not continuous or consistent in output" matches this directly. The word conveys nothing about environmental harm, cost, or human labor.',
            },
            {
              id: 19,
              paragraph: null,
              question_type: 'prose_summary',
              text: 'An introductory sentence for a brief summary of the passage is provided below. Complete the summary by selecting the THREE answer choices that express the most important ideas in the passage. Some sentences do not belong in the summary because they express ideas that are not presented in the passage or are minor ideas in the passage.',
              lead_sentence: 'Renewable energy technologies offer significant environmental benefits over fossil fuels but also face challenges that ongoing innovation is working to address.',
              options: [
                'Solar panels, wind turbines, and hydroelectric plants reduce greenhouse gas emissions and decrease reliance on non-renewable fossil fuels.',
                'The intermittent nature of solar and wind power — dependent on weather conditions — creates a need for advanced energy storage solutions.',
                'Researchers and governments are actively investing in improved technology, such as more efficient solar panels and better storage systems, to overcome current limitations.',
                'Renewable energy has already replaced fossil fuels as the dominant global energy source, driven by rapidly declining installation costs.',
                'Hydroelectric power is recognized as the most cost-effective and widely deployed renewable energy technology, with minimal environmental drawbacks.',
                'The high upfront cost of renewable infrastructure makes it economically impractical in most regions, meaning fossil fuels will remain the primary energy source indefinitely.',
              ],
              correct: [0, 1, 2],
              explanation: 'The three main ideas in the passage are: (A) environmental benefits of solar, wind, and hydroelectric power (P1); (B) the intermittency challenge requiring storage solutions (P2); and (C) recent innovations addressing these limitations (P3). Option D overstates current adoption — the passage says renewable energy is "increasingly gaining attention," not that it has replaced fossil fuels. Option E makes a comparative claim about hydroelectric power not supported by the text. Option F contradicts the passage\'s optimistic third paragraph, which describes meaningful progress and investment.',
            },
          ],
        },
      ],
...
Beyond individual species, ocean acidification threatens entire food webs. Pteropods — small free-swimming snails sometimes called "sea butterflies" — are a foundational food source for salmon, herring, and baleen whales in many ocean regions. Studies have already documented shell dissolution in pteropods collected from parts of the Southern Ocean and the Pacific Northwest. If pteropod populations collapse, the cascading effects on commercial fisheries and marine ecosystems could be profound. Scientists emphasize that unlike many other environmental stressors, ocean acidification is directly tied to atmospheric CO₂ concentrations, meaning meaningful reduction in carbon emissions represents the most effective long-term solution.`,
          questions: [
            ...
            },
            {
              id: 23,
              paragraph: 1,
              text: 'The word "inhibits" in paragraph 2 is closest in meaning to',
              options: [
              ...
              correct: 0,
              question_type: 'vocab',
              highlighted_word: 'inhibits',
              explanation: '"Inhibits" means to prevent or restrain a process. The passage states elevated acidity "inhibits shell formation in mollusks" — meaning it prevents or slows that biological process. "Dissolves" describes a separate effect mentioned for coral skeletons. "Measures precisely" and "greatly accelerates" are both opposite or unrelated in meaning.',
            },
            {
              id: 24,
              paragraph: 1,
              text: 'Why does the author include the statistic that coral reefs "support roughly 25% of all marine biodiversity despite covering less than 1% of the ocean floor"?',
              options: [
                'To show that coral reefs have significantly expanded their range in recent decades',
                'To argue that conservation funding should be directed exclusively to coral reefs',
                'To emphasize the disproportionate ecological importance of coral reefs',
                'To explain why corals are more chemically resistant to acidification than mollusks',
              ],
              correct: 2,
              question_type: 'purpose',
              highlighted_word: '25% of all marine biodiversity',
              explanation: 'The 25%/<1% contrast shows that coral reefs support an outsized share of marine biodiversity relative to their physical size. The author includes this to underscore why the prospect of "widespread bleaching and structural collapse" is ecologically catastrophic. The statistic is not about recent expansion, exclusive funding priorities, or chemical resistance.',
            },
            {
              id: 22,
              paragraph: null,
              question_type: 'prose_summary',
              text: 'An introductory sentence for a brief summary of the passage is provided below. Complete the summary by selecting the THREE answer choices that express the most important ideas in the passage. Some sentences do not belong in the summary because they express ideas that are not presented in the passage or are minor ideas in the passage.',
              lead_sentence: 'Ocean acidification, caused by the ocean\'s absorption of carbon dioxide, threatens marine life and food webs, with meaningful carbon emission reductions as the most effective remedy.',
              options: [
                'When oceans absorb CO₂, it forms carbonic acid that lowers seawater pH — a process called ocean acidification that has measurably increased since the pre-industrial era.',
                'Marine organisms that build shells or skeletons from calcium carbonate, including corals, oysters, and mussels, are especially vulnerable because acidity reduces calcium carbonate availability.',
                'The potential collapse of pteropod populations could cascade through food webs, threatening commercial fisheries and reinforcing the case for reducing atmospheric CO₂ as the primary solution.',
                'Ocean acidification is primarily caused by rising sea temperatures rather than changes in water chemistry, and its effects are limited to tropical coral reef ecosystems.',
                'The pH of the ocean has declined sharply from 8.2 to 7.5 since the industrial era, causing the confirmed extinction of several shellfish and coral species.',
                'Coral reefs are uniquely resistant to acidification because their high biodiversity allows rapid regeneration of calcium carbonate structures faster than acidification can dissolve them.',
              ],
              correct: [0, 1, 2],
              explanation: 'The passage\'s three main ideas are: (A) the chemical mechanism of ocean acidification and its measured pH decline (P1); (B) the vulnerability of calcifying organisms like corals and mollusks (P2); and (C) food web disruption via pteropods and the primacy of CO₂ reduction as a solution (P3). Option D contradicts the passage, which identifies CO₂ chemistry — not temperature — as the cause, and describes impacts beyond tropical reefs. Option E fabricates the pH figure (7.5 vs the actual 8.1) and claims extinction the passage does not assert. Option F directly contradicts the passage\'s description of coral reefs as facing "widespread bleaching and structural collapse."',
            },
          ],
        },
      ],
...
The nutritional and agricultural dimensions of the Columbian Exchange were equally transformative. The introduction of the potato to Europe helped sustain population growth in cool, northern climates where traditional grain crops underperformed. Maize became a caloric staple across parts of Africa. Meanwhile, Old World crops like sugarcane and coffee, transplanted to tropical regions of the Americas, generated plantation economies that drove the Atlantic slave trade. These cascading effects illustrate how a set of biological transfers initiated in the late fifteenth century continued to reshape political, economic, and social structures for centuries thereafter.`,
      questions: [
        ...
        },
        {
          id: 23,
          paragraph: 1,
          text: 'The word "catastrophic" in paragraph 2 is closest in meaning to',
          options: [
            'causing widespread devastation and suffering',
            'sudden and entirely unexpected',
            'affecting only a small or isolated region',
            'occurring gradually over many generations',
          ],
          correct: 0,
          question_type: 'vocab',
          highlighted_word: 'catastrophic',
          explanation: '"Catastrophic" means causing enormous damage or suffering. The passage uses it to describe the demographic consequences for Indigenous peoples — mortality rates of 50 to 90 percent in some regions within a century. "Causing widespread devastation and suffering" matches this directly. The passage portrays the collapse as large-scale and severe, not localized or gradual.',
        },
        {
          id: 24,
          paragraph: 2,
          text: 'Why does the author mention the introduction of sugarcane and coffee to the Americas in paragraph 3?',
          options: [
            'To argue that Old World crops were more nutritious than those originating in the Americas',
            'To illustrate how biological transfers had lasting social and economic consequences',
            'To explain how the Columbian Exchange improved living conditions for Indigenous peoples',
            'To describe which crops were best suited to tropical climates in the New World',
          ],
          correct: 1,
          question_type: 'purpose',
          highlighted_word: 'sugarcane and coffee',
          explanation: 'The passage mentions sugarcane and coffee as examples of Old World crops transplanted to the Americas that "generated plantation economies that drove the Atlantic slave trade." The author\'s purpose is to show how a biological transfer — moving crop species — produced profound political and social consequences lasting centuries. The passage is not comparing nutritional value, improving Indigenous conditions, or cataloguing climate-matched crops.',
        },
        {
          id: 22,
          paragraph: null,
          question_type: 'prose_summary',
          text: 'An introductory sentence for a brief summary of the passage is provided below. Complete the summary by selecting the THREE answer choices that express the most important ideas in the passage. Some sentences do not belong in the summary because they express ideas that are not presented in the passage or are minor ideas in the passage.',
          lead_sentence: 'The Columbian Exchange, set in motion by Columbus\'s 1492 voyages, produced profound and asymmetrical consequences for populations, agriculture, and economies across the Atlantic world.',
          options: [
            'While the Americas contributed major food crops such as maize, potatoes, and tomatoes to the Old World, Europe introduced livestock, wheat, and devastating pathogens to which Indigenous peoples had no immunity.',
            'European diseases caused catastrophic mortality among Indigenous Americans, with some historians arguing this demographic collapse was more central to establishing colonial dominance than military conquest.',
            'New World crops like the potato sustained population growth in northern Europe, while Old World plantation crops transplanted to the Americas — including sugarcane and coffee — drove the Atlantic slave trade.',
            'The Columbian Exchange was ultimately beneficial for all parties, as new food crops improved nutrition globally and any negative consequences were short-lived and limited to the sixteenth century.',
            'Columbus deliberately introduced European pathogens as a strategic tool to weaken Indigenous resistance and facilitate rapid Spanish territorial expansion.',
            'The exchange of horses and cattle between the Americas and Europe had a greater demographic impact than the spread of disease, fundamentally reshaping both continents\' agricultural economies.',
          ],
          correct: [0, 1, 2],
          explanation: 'The passage\'s three main arguments are: (A) the asymmetrical nature of the biological exchange — crops from the Americas, but crops plus deadly pathogens from Europe (P1); (B) the catastrophic demographic collapse of Indigenous peoples from disease, which some historians identify as the primary driver of colonial success (P2); and (C) the agricultural and economic transformations in both hemispheres, including the potato in Europe and plantation slavery in the Americas (P3). Option D ignores the catastrophic consequences for Indigenous peoples and the slave trade. Option E introduces deliberate intent that the passage does not claim — the spread of disease is not described as strategic. Option F reverses the factual significance of these elements; the passage emphasizes disease mortality above all other factors.',
        },
      ],
    },
  ],
...
The reconstructive nature of memory carries significant implications across multiple domains. In legal contexts, it underlines the unreliability of eyewitness testimony and supports the use of corroborating physical evidence. In education, it argues for teaching strategies that encourage elaborative encoding — connecting new material to existing knowledge — rather than rote repetition. In clinical psychology, it informs therapies that aim to weaken traumatic memories by introducing new, neutral associations during the reconsolidation window.`,
      questions: [
        ...
        },
        {
          id: 14,
          paragraph: 1,
          text: 'The word "schemas" in paragraph 2 is closest in meaning to',
          options: [
            'existing mental frameworks that shape interpretation',
            'biological sequences recorded in neural tissue',
            'written records of culturally shared stories',
            'formal rules of grammar and syntax',
          ],
          correct: 0,
          question_type: 'vocab',
          highlighted_word: 'schemas',
          explanation: 'In cognitive psychology, "schemas" refers to organized mental frameworks — prior knowledge structures that shape how we interpret new information. Bartlett found participants replaced unfamiliar story elements with familiar ones from their own cultural background, guided by their schemas. "Existing mental frameworks that shape interpretation" captures this precisely. Schemas are mental, not biological sequences, written records, or grammar rules.',
        },
        {
          id: 15,
          paragraph: 2,
          text: 'Why does the author mention that participants reported seeing broken glass that was not present in the original video?',
          options: [
            'To show that video recordings are less accurate than direct observation',
            'To illustrate how post-event information can create entirely false memories',
            'To argue that emotional stress causes participants to misremember visual details',
            'To explain why courts should not permit video footage as evidence',
          ],
          correct: 1,
          question_type: 'purpose',
          highlighted_word: 'broken glass',
          explanation: 'The broken glass example shows participants did not simply modify a real detail — they recalled something completely absent from the original event. This is the most striking demonstration that post-event information can plant fully fabricated memories. The author\'s purpose is to illustrate memory fabrication (not camera reliability, emotional stress effects, or legal policy arguments).',
        },
        {
          id: 13,
          paragraph: null,
          question_type: 'prose_summary',
          text: 'An introductory sentence for a brief summary of the passage is provided below. Complete the summary by selecting the THREE answer choices that express the most important ideas in the passage. Some sentences do not belong in the summary because they express ideas that are not presented in the passage or are minor ideas in the passage.',
          lead_sentence: 'Human memory is not a faithful recording of past events but an active reconstruction process, a property supported by experimental research and with significant real-world implications.',
          options: [
            'Research by Bartlett and Loftus demonstrated that memories are shaped by prior knowledge schemas and by information received after an event, confirming their reconstructive nature.',
            'The hippocampus binds the elements of episodic memories into traces that become temporarily unstable during retrieval — a process called reconsolidation — making them susceptible to modification.',
            'The fallibility of reconstructive memory has prompted reforms in legal eyewitness practices, influenced educational strategies favoring elaborative encoding, and informed clinical therapies for trauma.',
            'Once memories are consolidated by the hippocampus, they become permanent and immune to alteration by subsequent experiences or repeated retrieval.',
            'Loftus\'s research proved that eyewitness testimony is so fundamentally unreliable that courts should eliminate it entirely as a form of evidence, regardless of corroborating details.',
            'Bartlett\'s participants reproduced unfamiliar folk tales with high accuracy across repeated recalls, suggesting that culturally unfamiliar content is stored in a distinct, distortion-resistant memory system.',
          ],
          correct: [0, 1, 2],
          explanation: 'The three main ideas in the passage are: (A) experimental evidence from Bartlett and Loftus confirming memory\'s reconstructive, schema-driven, and post-event-alterable nature (P2–P3); (B) the neurological basis — hippocampal binding and reconsolidation — that makes memories susceptible to modification during retrieval (P4); and (C) the practical implications across legal, educational, and clinical domains (P5). Option D directly contradicts the passage\'s discussion of reconsolidation, which shows memories can be altered during retrieval. Option E overstates Loftus\'s conclusion — the passage says her research prompted reforms, not the abolition of eyewitness evidence. Option F directly contradicts Bartlett\'s findings: participants showed systematic distortions, not high accuracy.',
        },
      ],
    },
  ],
...
The CPH has important implications for education policy and language teaching. If a sensitive period for language acquisition exists, early childhood language programs may yield disproportionate long-term benefits. Some researchers have applied CPH reasoning to argue for bilingual education beginning in kindergarten rather than secondary school. However, others caution that the hypothesis has been overgeneralized — not all aspects of language are equally sensitive to age, and motivation, instruction quality, and amount of exposure remain powerful predictors of success at any age.`,
      questions: [
        ...
        },
        {
          id: 25,
          paragraph: 0,
          text: 'According to the passage, which of the following is NOT true about the Critical Period Hypothesis?',
          options: [
            'It was first formally put forward by a neurologist before being extended by a linguist.',
            'Lenneberg claimed the hypothesis applied specifically to vocabulary development rather than language as a whole.',
            'Evidence for the hypothesis comes from case studies of children denied early exposure to language.',
            'The hypothesis links effective language acquisition to a developmental window that closes around puberty.',
          ],
          correct: 1,
          question_type: 'negative_fact',
          explanation: 'Option B is false — Lenneberg argued that language acquisition as a whole must occur before puberty, not that vocabulary specifically is constrained. The passage actually shows the opposite: Genie developed vocabulary but failed to acquire grammar, suggesting vocabulary may be less dependent on the critical period. Options A (Penfield, a neurologist, first articulated it; Lenneberg, a linguist, later expanded it), C (evidence from isolated-child case studies like Genie), and D (the window closes around puberty) are all explicitly stated in the passage.',
        },
        {
          id: 18,
          paragraph: 1,
        ...
        },
        {
          id: 23,
          paragraph: 1,
          text: 'The word "nuanced" in paragraph 2 is closest in meaning to',
          options: [
            'involving subtle distinctions and complexity',
            'directly supporting the main argument',
            'based on a single clear and simple principle',
            'contradicting the findings of earlier research',
          ],
          correct: 0,
          question_type: 'vocab',
          highlighted_word: 'nuanced',
          explanation: '"Nuanced" means having subtle shades of meaning or careful distinctions. The passage says second language acquisition research presents "a more nuanced picture" than the CPH — meaning the evidence is more complex and subtle than a binary yes/no. Adults can achieve proficiency in some areas but not others. "Involving subtle distinctions and complexity" captures this. The word signals complexity, not direct support, simplicity, or contradiction.',
        },
        {
          id: 24,
          paragraph: 1,
          text: 'Why does the author discuss the case of Genie in paragraph 2?',
          options: [
            'To present the most widely cited case study in support of the Critical Period Hypothesis',
            'To argue that psychological trauma is the primary cause of all language impairment',
            'To explain why adult second language learners struggle specifically with pronunciation',
            'To suggest that the CPH has been rejected by most researchers in the field',
          ],
          correct: 0,
          question_type: 'purpose',
          highlighted_word: 'Genie',
          explanation: 'The passage introduces Genie as "the most widely cited evidence for the CPH" — her failure to acquire normal grammatical competence after missing the critical period supports the hypothesis. The author then acknowledges the methodological limitation (trauma and deprivation confound the results). The purpose is to present the strongest evidential case for the CPH, not to argue about trauma as a universal cause, pronunciation challenges, or rejection of the theory.',
        },
        {
          id: 22,
